...
import { ChevronDown, Target, List, Lightbulb, Archive, Settings, BarChart3, Activity, PenLine, CalendarDays, Clock, LayoutDashboard } from "lucide-react"
                        ...
                        <div>
                            <DropdownMenuTrigger asChild>
                                <Button variant="ghost" className="gap-2 font-normal text-muted-foreground hover:text-foreground relative">
                                    ...
                                    {view === 'focus' ? 'Focus Mode' : view === 'queue' ? 'Queue' : view === 'board' ? 'Board' : view === 'analytics' ? 'Analytics' : view === 'capture' ? 'Capture' : view === 'calendar' ? 'Upcoming' : view === 'planner' ? 'Planner' : 'Idea Dump'}
