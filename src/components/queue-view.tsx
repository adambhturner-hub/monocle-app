...
function QueueContent({ defaultTab, variant = 'sheet', mode = 'active' }: { defaultTab?: 'active' | 'drafts', variant?: 'sheet' | 'fullscreen', mode?: 'active' | 'drafts' }) {
    ...
    const [sortMode, setSortMode] = useState<'manual' | 'date'>(settings.sortMode);
...
export function QueueView({ customTrigger, defaultTab, variant = 'sheet', mode = 'active' }: QueueViewProps & { variant?: 'sheet' | 'fullscreen', mode?: 'active' | 'drafts' }) {
